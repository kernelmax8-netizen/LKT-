...
export default function Step3GetQuotations({
  ...
  const acceptQuote = (vendorId) => updateOrder({ selectedVendorId: vendorId });
  ...
  if (!quotesReceived) {
    return (
      ...
      <div className="flex-1 min-w-0 bg-white border border-[#F1E7D4] rounded-2xl p-6 sm:p-10">
        ...
        <div className="border border-[#F1E7D4] rounded-xl divide-y divide-[#F1E7D4] mb-8">
          ...
          <div className="flex items-center justify-between px-5 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-gray-900">Sending quotation request</p>
                <p className="text-xs text-gray-500">Request sent to vendors</p>
              </div>
            </div>
        ...
        <div className="flex items-start gap-2 bg-[#FBF1DC] border border-[#F0DFB4] rounded-lg px-4 py-3 mb-6">
          <Bell size={16} className="text-brand-orange mt-0.5 flex-shrink-0" />
          <div>
            <p className="text-sm font-bold text-gray-900">Quotations are on the way!</p>
            <p className="text-xs text-gray-500">You'll be notified as soon as vendors send their quotations.</p>
          </div>
        </div>
        ...
        <div className="border border-[#F1E7D4] rounded-xl p-6 text-center">
          ...
          <p className="text-xl font-extrabold text-brand-green mb-1">45 – 60 seconds</p>
          <p className="text-xs text-gray-500 mb-4">You can leave this screen. We'll notify you when quotations are ready.</p>
          <button
            type="button"
          ...
          >
            <Bell size={15} />
            Notify me when quotations arrive
          </button>
      ...
      <aside className="w-full lg:w-80 flex-shrink-0 space-y-5">
        ...
        <div className="flex items-start gap-2 bg-[#EEF3E4] border border-[#DCE7C8] rounded-xl px-4 py-3.5">
          ...
          <p className="text-xs text-gray-700">Verified &amp; Trusted Vendors — All vendors on Lakdi Ki Taal are verified for quality, pricing and on-time delivery.</p>
        </div>
        <WhyBookWithUs />
        <NeedHelpCard />
      </aside>
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-start">
      ...
      <div className="flex items-start gap-3 bg-[#EEF3E4] border border-[#DCE7C8] rounded-lg px-4 py-3 mb-6">
        ...
        <div>
          <p className="text-sm font-bold text-gray-900">Great! We received quotations from {vendors.length} verified vendors.</p>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          type="button"
          onClick={onNext}
          className="flex-1 flex items-center justify-center gap-2 bg-brand-green hover:bg-brand-green-dark text-white font-bold py-3.5 rounded-xl transition-colors duration-200 shadow-md"
        >
